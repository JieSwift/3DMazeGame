...
(function (core,animation) {
    ...
    function renderer_transition(context, actor) {
        ...
        context.fillRect(1, 1, windowWidth, windowHeight);
        context.restore();
    };
    ...
    Alistuff.ext(core.GameAnimationState, core.State, {
        ...
        update: function (deltaTime) {
          ...
          var endTime = 206;
          this.skipAnimation(endTime,'skip');
        },

        skipAnimation:function (endTime,name) {
          var self = this;
          var skip = document.getElementById(name);
          skip.addEventListener('click', function () {
            self.stage.skip(endTime);
        ...
        playClip1: function () {
            ...
            this.stage
            .addActor(new animation.TextActor('《抑郁症患者 走出迷宫》', renderer_dynamicText, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('程序：何敏杰', renderer_dynamicText, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('设计：何敏杰', renderer_dynamicText, 800, 400, 0, 0, 0, 0)
            ...
            .addAnimation(186, 188, new animation.AlphaAnimation(-1)))
            .addActor(new animation.TextActor('我对一切都失去了热情', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我的生活不再有意义', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我拼命逃离', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我逃离社会', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我逃离人群', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我逃离自己', renderer_text20px, 800, 400, 0, 0, 0, 0)
            .addAnimation(132, 143, new animation.EmptyAnimation())
            .addAnimation(132, 136, new animation.AlphaAnimation(1)))
            .addActor(new animation.TextActor('我筑起围城禁锢自己', renderer_text20px, 830, 420, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我的世界开始变得越来越小', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我变得无立足之地', renderer_text20px, 830, 420, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我坠入了万丈深渊', renderer_text20px, 800, 400, 0, 0, 0, 0)
        ...
        playClip2: function () {
            ...
            .addActor(new animation.TextActor('我的逐渐好转', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我对一切恢复了热情', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我的生活再次有了意义', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我尝试拥抱', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我拥抱社会', renderer_text20px,800, 400, 0, 0, 0, 0)
            .addAnimation(54, 58, new animation.EmptyAnimation())
            .addAnimation(54, 56, new animation.AlphaAnimation(1))
            .addAnimation(56, 58, new animation.AlphaAnimation(-1)))
            .addActor(new animation.TextActor('我拥抱人群', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我拥抱自己', renderer_text20px, 800, 400, 0, 0, 0, 0)
            .addAnimation(76, 85, new animation.EmptyAnimation())
            .addAnimation(76, 78, new animation.AlphaAnimation(1)))
            .addActor(new animation.TextActor('我凿开禁锢的围墙', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我的世界开始变得越来越大', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('我变得拥有一切', renderer_text20px, 800, 400, 0, 0, 0, 0)
        ...
        playClip3: function () {
            this.stage = new animation.Stage();
            this.stage
            .addActor(new animation.TextActor('醒醒...', renderer_text20px, 800, 400, 0, 0, 0, 0)
            ...
            .addActor(new animation.TextActor('第250号患者你吃药时间到了……', renderer_text20px, 800, 400, 0, 0, 0, 0)
        ...
        stopSound: function (id) {
            this.game.stopSound(this.bgmFile);
