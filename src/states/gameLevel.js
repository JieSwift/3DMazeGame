...
(function (core, animation, lv, et, renderer) {
  ...
  Alistuff.ext(core.GameLevelState, core.State, {
    ...
    pauseSound:function (audio) {
      return this.game.pauseSound(audio);
    },
    resumeSound:function(audio){
      return this.game.resumeSound(audio);
    }
  });
  ...
  Alistuff.ext(core.GameMenuState, core.State, {
    ...
    render: function (context) {
      ...
      context.fillText(this.title, this.width/2-this.offset, 60);

      for (var i = 0; i < this.menus.length; i++) {
        var x = this.width/2-this.offset
        var y = this.height/2 + i * 40-this.offset;
      ...
      context.fillStyle = '#fff';
      context.font = this.font_sml;
      context.fillText('[Enter 确认]', this.width/2-this.offset, this.height/2+this.offset);
  ...
  Alistuff.ext(core.GameLevel1State, core.GameLevelState, {
    ...
    start: function (game) {
      ...
      game.addKeyListener('q', function () {
        self.player.rotateLeft();
      });
      game.addKeyListener('e', function () {
  ...
  core.GameEndState = function () {
    ...
    this.words = [
      {title: 'Programming', items: ['771299500@qq.com']},
      {
