...
(function (lv, et) {
    lv.DungeonLevel = function (gameState) {
        ...
        audioIcon.addEventListener('click',function(){
          if(isPlaySound){
            gameState.pauseSound(bgm);
            audioIcon.src = 'res/tex/images/audioClose.png';
            isPlaySound = false;
          }else{
            gameState.resumeSound(bgm);
            audioIcon.src = 'res/tex/images/audio.png';
            isPlaySound = true;
          }
        },false);
        ...
        this.events = [
            ...
            { event: 96 * this.width + 13, excute: function () { gameState.textFadeInOut("我不知身在何处",  800, 400, 2, 0.5); } },
            { event: 87 * this.width + 13, excute: function () { gameState.textFadeInOut("我只能在黑暗中前行",  800, 400, 3, 1);  } },
            { event: 68 * this.width + 13, excute: function () { gameState.textFadeInOut("我无数次碰壁",  800, 400, 3, 1); gameState.playSound('Horror Ambient'); } },
            { event: 45 * this.width + 19, excute: function () { gameState.textFadeInOut("我走了许多弯路",  800, 400, 3, 1); gameState.playSound('Horror Ambient'); } },
            { event: 79 * this.width + 21, excute: function () { gameState.playSound('Horror Ambient'); } },
            { event: 39 * this.width + 11, excute: function () { gameState.textFadeInOut("我碰到许多险恶",  800, 400, 3, 1); } },
            { event: 17 * this.width + 8, excute: function () { gameState.textFadeInOut("我拼命逃离",  800, 400, 2, 0); } },
            { event: 16 * this.width + 11, excute: function () { gameState.textFadeInOut("我逃离黑暗",  800, 400, 2, 0); } },
            { event: 13 * this.width + 15, excute: function () { gameState.textFadeInOut("我逃离恐惧",  800, 400, 2, 0); } },
            { event: 9 * this.width + 15, excute: function () { gameState.textFadeInOut("我逃离封闭",  800, 400, 2, 0); } },
            ...
            { event: 76 * this.width + 1, excute: function () { addGhost.call(this, 15, 81); } },
            { event: 41 * this.width + 25, excute: function () { addGhost.call(this, 20, 41); } },
            { event: 18 * this.width + 22, excute: function () { addGhost.call(this, 22, 18); } },
            { event: 20 * this.width + 19, excute: function () { openDoor.call(this,10, 19); } },
            { event: 58 * this.width + 8, excute: function () { addGhost.call(this, 60, 57); } },
            { event: 76 * this.width + 16, excute: function () { addGhost.call(this, 58, 81); } },
            { event: 41 * this.width + 40, excute: function () { addGhost.call(this, 49, 36); } },
            { event: 18 * this.width + 55, excute: function () { addGhost.call(this, 26, 15); } },
            {
                event: 3 * this.width + 15, excute: function () {
                    ...
                    gameState.textFadeInOut("我向往光明",  800, 400, 2, 0, 0xffffff, nextLevel);
                }
            }
        ];
